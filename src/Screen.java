...
{	
  ...
  public void instantiateWordList()
  {
  ...
  {
	  this.beginLabel = new JLabel("<html><center><bold>[SpeedTyper]</bold></center><center>Press SPACE to begin</center><center>Choose difficulty: 1(Easy)-3(Hard)</center><center>Choose Language: 4-EN, 5-FR, 6-IT</center><center>Hit ESC to exit</center><html>", SwingConstants.CENTER);
	  add(this.beginLabel);
  ...
  public void updateTitle(Graphics g)
  {
	  this.beginLabel.setText("<html><center><bold>[SpeedTyper]</bold></center><center>Press SPACE to begin</center><center>Choose difficulty: 1(Easy)-3(Hard)</center><center>Choose Language: 4-EN, 5-FR, 6-IT</center><center>Hit ESC to exit</center><html>");
	  g.setColor(new Color(0, 0, 0));
      g.fillRect(0, 0, (int)Main.ScreenSize.getWidth(), (int)Main.ScreenSize.getHeight());
  }
  
  public void updateGameplay(Graphics g)
  {
	  g.setColor(new Color(0, 0, 0));
      g.fillRect(0, 0, (int)Main.ScreenSize.getWidth(), (int)Main.ScreenSize.getHeight());
  ...
  public void updateEnd(Graphics g)
  {
	  int total = 0;
      ...
      this.statsTwo.setForeground(Color.black);
      this.statsThree.setForeground(Color.black);
      this.beginLabel.setText("<html><center>Game Over!</center><center>Score: " + this.score + "</center><center>Average Words Per Minute: " + totalAvg + "</center><center>ESC to exit, Home to replay</center><center>Hit 9 on title for DEMON difficulty!</center></html>");
  }
  ...
  public void wordLogic()
  {
	  for (int i = 0; i < this.words.length; i++) 
	  {
		  if (this.words[i] != null) 
	      {
			  ...
			  else if (((this.words[i] != null)) & ((this.words[i].getBounds().getY() > this.screenSize.getHeight() - SCREEN_CLEARANCE))) 
			  {
				  this.words[i] = null;
			  } 
	      }
  ...
  public boolean makeWordsOnBuffer()
  {
  ...
  public void checkWordIntersection()
  {
	  for (int i = 0; i < this.words.length; i++) 
	  {
		  if (this.words[i] != null) 
	      {
			  ...
			  {
				  if (this.words[j] != null && this.words[i] != null && i != j && this.words[j].getBounds().intersects(this.words[i].getBounds())) 
				  {
					  this.words[j] = null;
				  }
			  } 
  ...
  public void fillArrayWhenDepleted()
  {
	  int nullCnt = 0;
	  for (int i = 0; i < this.words.length; i++) 
	  {
  ...
  public void keyPressed(KeyEvent e) 
  {
	  ...
	  { 
		  ...
		  if ((e.getKeyCode() > SMALLEST_UPPER && e.getKeyCode() < BIGGEST_UPPER) || (e.getKeyCode() > SMALLEST_LOWER && e.getKeyCode() < BIGGEST_LOWER))
		  { 
  ...
  public void checkSettings(KeyEvent e)
  {
