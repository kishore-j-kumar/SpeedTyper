...
public class Word 
{
  ...
  public Word(int challengeLevel, List<String> words) 
  {
	  ...
	  this.wrd = (String)words.get(yourRandom.nextInt(words.size()));
  }
  ...
  void draw(Graphics g) 
  {
    ...
    this.boundary = new Rectangle(this.x, this.y - (int)this.fontBoundary.getHeight(), (int)this.fontBoundary.getWidth(), (int)this.fontBoundary.getHeight());
  }
  ...
  {
    this.x = 0;
    this.y = (int)(Math.random() * this.screenSize.getHeight()) + WORD_RESTART_BUFFER;
  }
}
